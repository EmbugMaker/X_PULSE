...
#define AI_NETWORK_MODEL_SIGNATURE     "2e0f2d8bbb2fb4ce989bd8ccec502069"
...
#define AI_TOOLS_DATE_TIME   "Wed Oct 26 20:27:56 2022"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 2372, 1, 1),
    2372, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_1_weights_array.data = AI_PTR(g_network_weights_map[0] + 64);
    dense_1_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 64);
    
    dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 1088);
    dense_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1088);
    
    dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 1152);
    dense_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 1152);
    
    dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 2176);
    dense_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 2176);
    
    dense_3_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_weights_array.data = AI_PTR(g_network_weights_map[0] + 2240);
    dense_3_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 2240);
    
    dense_3_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_3_bias_array.data = AI_PTR(g_network_weights_map[0] + 2304);
    dense_3_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 2304);
    
    dense_0_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_0_weights_array.data = AI_PTR(g_network_weights_map[0] + 2308);
    dense_0_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 2308);
